...
STARTER_TEMPLATES = [
    ...
    },
    {
        ...
        "definition": {
            "form": {"key": "maengelmeldung", "title": "Maengelmeldung"},
            "fields": [
                field("datum", "Datum", "date", required=True),
                field("ort", "Ort", required=True),
                select(
                    "prioritaet",
                    "Prioritaet",
                    [("normal", "Normal"), ("hoch", "Hoch"), ("kritisch", "Kritisch")],
                    required=True,
                ),
                field("beschreibung", "Beschreibung", "textarea", required=True),
                field("frist", "Gewuenschte Frist", "date"),
            ],
            "action_item_rules": [
                {
                    "name": "Mangel erzeugt Massnahme",
                    "source_field_key": "beschreibung",
                    "operator": "is_not_empty",
                    "title_template": "Mangel: {ort}",
                    "description_template": "{beschreibung}",
                    "due_at_field_key": "frist",
                    "priority": "normal",
                }
            ],
    ...
    },
    {
        ...
        "definition": {
            "form": {"key": "schluesseluebergabe", "title": "Schluesseluebergabe"},
            "fields": [
                field("datum", "Datum", "date", required=True),
                field("bewohner_name", "Bewohner/in", required=True),
                select(
                    "vorgang",
                    "Vorgang",
                    [("ausgabe", "Ausgabe"), ("ruecknahme", "Ruecknahme")],
                    required=True,
                ),
                field("schluesselnummer", "Schluesselnummer", required=True),
                field("unterschrift", "Unterschrift", "signature", required=True),
            ],
        },
    },
    {
        ...
        "definition": {
            "form": {"key": "brandschutzkontrolle", "title": "Brandschutzkontrolle"},
            "fields": [
                field("datum", "Datum", "date", required=True),
                field("bereich", "Bereich", required=True),
                select(
                    "fluchtwege", "Fluchtwege frei", [("ja", "Ja"), ("nein", "Nein")], required=True
                ),
                select(
                    "loescher",
                    "Feuerloescher sichtbar/erreichbar",
                    [("ja", "Ja"), ("nein", "Nein")],
                    required=True,
                ),
                field("bemerkung", "Bemerkung", "textarea"),
                field("frist", "Frist bei Mangel", "date"),
            ],
            "action_item_rules": [
                {
                    "name": "Brandschutzmangel",
                    "source_field_key": "fluchtwege",
                    "operator": "equals",
                    "value": "nein",
                    "title_template": "Brandschutz: Fluchtweg pruefen",
                    "description_template": "{bemerkung}",
                    "due_at_field_key": "frist",
                    "priority": "critical",
                }
            ],
    ...
    },
    {
        ...
        "definition": {
            "form": {"key": "besucherprotokoll", "title": "Besucherprotokoll"},
            "fields": [
                field("datum", "Datum", "date", required=True),
                field("besucher_name", "Besucher/in", required=True),
                field("besuchte_person", "Besuchte Person / Bereich"),
                field("ankunft", "Ankunft"),
                field("ende", "Ende"),
                field("bemerkung", "Bemerkung", "textarea"),
            ],
        },
    },
    {
        ...
        "definition": {
            "form": {"key": "bewohneraufnahme-checkliste", "title": "Bewohneraufnahme Checkliste"},
            "fields": [
                field("bewohner_name", "Bewohner/in", required=True),
                field("aufnahmedatum", "Aufnahmedatum", "date", required=True),
                field("zimmer", "Zimmer"),
                field("unterlagen_vollstaendig", "Unterlagen vollstaendig", "boolean"),
                field("hausordnung_ausgehaendigt", "Hausordnung ausgehaendigt", "boolean"),
                field("bemerkung", "Bemerkung", "textarea"),
            ],
        },
    },
        ...
        "definition": {
            ...
            "fields": [
                ...
                select(
                    "status",
                    "Status",
                    [("liegt_vor", "liegt vor"), ("fehlt", "fehlt"), ("widerrufen", "widerrufen")],
                    required=True,
                ),
                field("bemerkung", "Bemerkung", "textarea"),
            ],
